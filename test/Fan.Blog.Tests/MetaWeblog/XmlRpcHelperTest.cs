  ...
  <param>
   <value>
    <boolean>1</boolean>
        ...
        private const string REQ_NEWPOSTCUSTOM = @"<?xml version=""1.0"" encoding=""utf-8""?>
<methodCall>
 <methodName>metaWeblog.newPost</methodName>
 <params>
  <param>
   ...
   <value>
    <struct>
     ...
     <member>
      <name>dateCreated</name>
      <value>
       <dateTime.iso8601>20190907T15:08:00</dateTime.iso8601>
      </value>
     </member>
     <member>
      <name>date_created_gmt</name>
     ...
     <member>
      ...
      <value>
       <base64></base64>
        ...
        /// </summary>
        [Theory]
        [InlineData(REQ_NEWPOST, "metaWeblog.newPost", "http://localhost:8000", "admin", "admin",
            "Welcome to Fanray", "welcome-to-fanray", "Technology", "blogging", "testing")]
        [InlineData(REQ_NEWPOSTCUSTOM, "metaWeblog.newPost", "http://localhost:8000", "admin", "admin",
            "Custom Post", "custom-post", "Testing", "custom", "testing")]
        public void TestParseNewPost_ReturnPublishedPost(string xmlName, string methodName, string blogId,
            string userName, string password, string title, string slug, string category0, string tag0,
            string tag1)
        {

            var request = _helper.ParseRequest(xmlName);

            Assert.Equal(methodName, request.MethodName);
            Assert.Equal(blogId, request.BlogId);
            Assert.Equal(userName, request.UserName);
            Assert.Equal(password, request.Password);
            Assert.Null(request.Post.PostId);
            Assert.Equal(title, request.Post.Title);
            Assert.Equal(slug, request.Post.Slug);
            Assert.Equal(category0, request.Post.Categories[0]);
            Assert.Equal(tag0, request.Post.Tags[0]);
            Assert.Equal(tag1, request.Post.Tags[1]);
        ...
        /// </summary>
        [Fact]
        public void TestParseEditPost_ReturnPublishedPost()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseGetPost_ReturnPost()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseGetPostCategories_ReturnPostCategories()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseNewPostCategory_ReturnNewCategory()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseGetRecentPosts_Return50Posts()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseGetUsersBlogs_ReturnUsersBlogs()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseDeletePost_ReturnDeletedPost()
        {
        ...
        /// </summary>
        [Fact]
        public void TestParseNewMediaObject_ReturnMediaObject()
        {
  ...
  <params>
    <param>
      <value>
        ...
        /// </summary>
        [Fact]
        public void TestBuildFaultOutput_shouldBeEqual()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void TestBuildNewPostOutput_shouldBeEqual()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void TestBuildGetPostOutput_shouldBeEqual()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void TestBuildGetCategoriesOutput_shouldBeEqual()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void BuildGetTagsOutput_shouldBeEqual()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void BuildNewMediaObjectOutput_shouldBeEqual()
        {
            // Arrange
